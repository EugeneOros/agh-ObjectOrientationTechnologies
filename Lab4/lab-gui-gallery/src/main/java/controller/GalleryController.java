...
public class GalleryController {
    ...
    public void initialize() {
        // additional FX controls initialization
    ...
    private void bindSelectedPhoto(Photo selectedPhoto) {
        // view <-> model bindings configuration
    ...
    public void searchButtonClicked(ActionEvent event) {
        ...
        galleryModel.clear();
        photoDownloader.searchForPhotos(searchTextField.getText()).subscribe(e -> Platform.runLater(() -> galleryModel.addPhoto(e)));
    }
}
